...
class ScreenshotTest {
    ...
    @Test fun devices_ar() = shot("ar-4-devices", results, scrollTo = 3 + findings.size + 1 + results.checks.size)
    ...
    @Test fun network_en() = shot("en-9-network", results, Lang.EN, scrollTo = 3 + findings.size)
    @Test fun devices_en() = shot("en-4-devices", results, Lang.EN, scrollTo = 3 + findings.size + 1 + results.checks.size)
